...
import { GameObject, Transform, AnimationClip, WaitForSeconds, Coroutine} from 'UnityEngine';
...
export default class GestureLoader extends ZepetoScriptBehaviour {
    ...
    private _poseIsRunning: boolean;
    ...
    private _isNotAPose(gestureType: OfficialContentType[]):boolean
    {
